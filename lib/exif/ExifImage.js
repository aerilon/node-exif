...
ExifImage.prototype.extractExifData = function (data, start, length) {
  ...
  var identification = data.getShort(tiffOffset)
    ...
    throw new Error('Invalid TIFF data! Expected 0x4949 or 0x4D4D at offset '+(tiffOffset)+' but found 0x'+identification.toString(16).toUpperCase()+".");
  }
  ...
  if (version != 42) {
    ...
    throw new Error('Invalid TIFF data! Expected 42 at offset '+ versionOffset +' but found 0x'+version.toString(16).toUpperCase()+".");
  }
