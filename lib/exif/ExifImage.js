...
ExifImage.prototype.extractExifData = function (data) {
  ...
  if (typeof makernoteIfdData != "undefined") {
    ...
    if (makernoteIfdData.getString(0, 7) === "OLYMP\x00\x01" || makernoteIfdData.getString(0, 7) === "OLYMP\x00\x02") {
      this.extractMakernotes = require('./makernotes/olympus').extractMakernotes;
    } else if (makernoteIfdData.getString(0, 7) === "AGFA \x00\x01") {
      this.extractMakernotes = require('./makernotes/agfa').extractMakernotes;
    } else if (makernoteIfdData.getString(0, 8) === "EPSON\x00\x01\x00") {
      this.extractMakernotes = require('./makernotes/epson').extractMakernotes;
    } else if (makernoteIfdData.getString(0, 8) === "FUJIFILM") {
      this.extractMakernotes = require('./makernotes/fujifilm').extractMakernotes;
    } else if (makernoteIfdData.getString(0, 9) === "Panasonic") {
      this.extractMakernotes = require('./makernotes/panasonic').extractMakernotes;
    } else if (makernoteIfdData.getString(0, 5) === "SANYO") {
