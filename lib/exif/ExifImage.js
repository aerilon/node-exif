...
ExifImage.prototype.loadImage = function (image) {

  if (image.constructor.name === 'Buffer') {
    this.processBuffer(image);
  } else if (image.constructor.name === 'String') {
    fs.open(image, 'r', this.processOpenedFile.bind(this))
  } else {
...
ExifImage.prototype.extractExifData = function (data) {
  ...
  // stored in little endian or 0x4D4D if it is stored in big endian
